...
class CreatApiPostProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
            CREATE PROCEDURE CreatPostApiProcedure(IN _namecat VARCHAR(255), IN _body VARCHAR(255),IN _nametype VARCHAR(255), IN _idfile INT(11), IN _firstname VARCHAR(255),IN _mobile VARCHAR(255), IN _email VARCHAR(255), IN _address VARCHAR(255), IN _name_status_type VARCHAR(250))
            BEGIN
                ...
                insert into impposts(idpost,id_status_type,percent_process,iduser_imp) values(_idpost,_id_status_type,_percent_process,_idcustomer);
